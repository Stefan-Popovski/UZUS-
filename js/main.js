...
function initQuizModal() {
  ...
  // Quiz Logic
  const questions = [
    { text: "Кога нешто се расипе дома, јас...", opts: ["Сакам сам/а да го поправам", "Истражувам зошто се случило тоа", "Ги замолувам другите да помогнат", "Не ме интересира многу"], types: ["R","I","S","C"] },
    { text: "Во слободното време најмногу уживам во...", opts: ["Работа со алати или опрема", "Читање и решавање загатки", "Дружење и помагање на другите", "Организирање и подредување"], types: ["R","I","S","C"] },
    { text: "На час по физика / математика...", opts: ["Сакам практични задачи и експерименти", "Сакам да разберам ЗОШТО нештата функционираат вака", "Сакам да работиме во групи", "Сакам јасни правила и формули"], types: ["R","I","S","C"] },
    { text: "Ако треба да опишам себеси, јас сум...", opts: ["Практичен/на и моторен/на", "Аналитичен/на и љубопитен/на", "Сочувствителен/на и грижлив/а", "Уреден/на и прецизен/на"], types: ["R","I","S","C"] },
    ...
    { text: "Кога гледам автомобил или мотор, мислам...", opts: ["Интересно, би сакал/а да ги разглобам!", "Прашувам се како точно работи моторот", "Размислувам за луѓето кои патуваат", "Забележувам дали се уредни и одржувани"], types: ["R","I","S","C"] },
    { text: "Во идниот живот сакам...", opts: ["Нешто да правам со рацете / физички да работам", "Да истражувам, анализирам, да решавам проблеми", "Да работам со луѓе и да им помагам", "Да работам уредно во канцеларија или систем"], types: ["R","I","S","C"] },
    { text: "Кога некој пријател ме моли за совет...", opts: ["Покажувам практично решение", "Анализираме заедно ситуацијата", "Слушам и поддржувам", "Им давам јасна, структурирана препорака"], types: ["R","I","S","C"] },
    { text: "Кога гледам некоја зграда или машина, прво мислам на...", opts: ["Конструкцијата — како е направена", "Принципите — зошто функционира вака", "Луѓето — кој работи/живее тука", "Системот — дали е сè уредено правилно"], types: ["R","I","S","C"] },
    { text: "На патување / екскурзија, јас сум тој/таа кој/која...", opts: ["Помага со багаж, техника, карта", "Истражува историјата или природата на местото", "Се грижи дека сите се добро и весело", "Ги паметам сите резервации и распоред"], types: ["R","I","S","C"] },
